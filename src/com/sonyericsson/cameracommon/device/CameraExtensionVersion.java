    ...
    public CameraExtensionVersion(String string) {
        try {
            ...
            if (arrstring.length >= 2) {
                this.mMajorVersion = Integer.parseInt((String)arrstring[0]);
                this.mMinorVersion = Integer.parseInt((String)arrstring[1]);
                return;
            }
            ...
            CameraLogger.e("CameraExtensionVersion", "version NumberFormatException:" + string, (Throwable)var2_3);
        }
    }
