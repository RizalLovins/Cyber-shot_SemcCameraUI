...
implements TouchMoveAndStopDetector.TouchStopDetectorListener {
    ...
    public CaptureArea(Context context, AttributeSet attributeSet) {
        ...
        this.mTouchMoveAndStopDetector = new TouchMoveAndStopDetector(ViewConfiguration.get((Context)this.getContext()).getScaledTouchSlop());
        this.mTouchMoveAndStopDetector.setTouchStopDetectorListener((TouchMoveAndStopDetector.TouchStopDetectorListener)this);
    ...
    private boolean hitTest(View view, MotionEvent motionEvent) {
        return super.hitTest(view, (int)motionEvent.getRawX(), (int)motionEvent.getRawY());
    }
...
lbl16: // 3 sources:
    ...
    public void onSingleTouchMoveDetected(Point point, Point point2, Point point3) {
        if (super.hitTest((View)this, point.x, point.y)) {
...
lbl11: // 5 sources:
            ...
            if (CaptureArea.access$300(CaptureArea.this, (View)CaptureArea.this, var2_2)) {
                if (CaptureArea.access$100(CaptureArea.this) != null) {
