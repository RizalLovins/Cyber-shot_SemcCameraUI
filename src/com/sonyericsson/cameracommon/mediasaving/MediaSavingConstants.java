...
public class MediaSavingConstants {
    ...
    static {
        ...
        EXTENDED_PHOTO_STORAGE_URI = Uri.parse((String)"content://media/external/extended_images/media");
        EXTENDED_VIDEO_STORAGE_URI = Uri.parse((String)"content://media/external/extended_video/media");
        STANDARD_PHOTO_STORAGE_URI = Uri.parse((String)"content://media/external/images/media");
