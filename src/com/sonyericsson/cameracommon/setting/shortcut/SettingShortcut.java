...
public class SettingShortcut {
    ...
    public SettingShortcut(Context context, ViewGroup viewGroup, ListView listView) {
        ...
        viewGroup.addView((View)this.mContainer);
        ...
        this.mContainer.addView((View)this.mItems);
        this.mItems.getLayoutParams().width = this.mIconSize;
        this.mItems.getLayoutParams().height = -1;
        ((android.widget.FrameLayout$LayoutParams)this.mItems.getLayoutParams()).gravity = 1;
    ...
    private boolean computeShortcutIconRect(int n, int n2, Rect rect) {
        ...
        rect3.offset(rect2.left, n * rect2.height() / n2);
    ...
    public boolean getSelectedItemIconVisibleRect(Rect rect) {
        ...
        for (int i = 0; i < settingAdapter.getCount(); ++i) {
            ...
            return super.computeShortcutIconRect(i, settingAdapter.getCount(), rect);
        }
        return false;
    }
    ...
    public void setAdapter(SettingAdapter settingAdapter) {
        super.updateItemHeight(this.mContainer.getMeasuredHeight());
        SettingItem settingItem = super.getSelected();
        this.mItems.setAdapter((ListAdapter)settingAdapter);
        if (settingItem != null) {
            super.setSelected(settingItem);
        }
        settingAdapter.registerDataSetObserver(this.mAdapterObserver);
        super.registerOnItemSelectedListener();
    }

    public <T> void setSelected(T t) {
        super.setSelected(SettingItemBuilder.build(t).commit());
    }
