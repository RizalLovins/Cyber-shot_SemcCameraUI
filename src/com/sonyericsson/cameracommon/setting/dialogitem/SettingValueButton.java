...
extends SettingDialogItem {
    ...
    public SettingValueButton(Context context, SettingItem settingItem) {
        super(settingItem);
        ...
        this.mHolder.mContainer = layoutInflater.inflate(R.layout.setting_item_value_button, null);
