...
extends ImageView {
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        this.mListener.onDispatchDraw((OnScreenButton)this, canvas);
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        switch (motionEvent.getAction()) {
            ...
            case 0: {
                ...
                this.mListener.onDown((OnScreenButton)this, motionEvent);
                return true;
            }
            case 3: {
                this.setPressed(false);
                this.mIsTouched = false;
                this.mListener.onCancel((OnScreenButton)this, motionEvent);
                return true;
            }
            case 2: {
                if (super.contains(motionEvent)) {
                    this.mListener.onMove((OnScreenButton)this, motionEvent);
                    return true;
                }
                this.setPressed(false);
                this.mIsTouched = false;
        ...
        if (super.contains(motionEvent) && this.mIsTouched) {
            this.setPressed(false);
            this.mIsTouched = true;
            this.mListener.onUp((OnScreenButton)this, motionEvent);
            return true;
        }
        this.setPressed(false);
        this.mIsTouched = false;
