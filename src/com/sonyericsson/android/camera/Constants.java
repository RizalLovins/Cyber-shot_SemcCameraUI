...
public class Constants {
    ...
    public static final boolean DEBUG_BITMAP_MANAGER_DUMP = 0;
    public static final boolean DEBUG_EMU = 0;
    public static final boolean DEBUG_EVENT_INTRUDER = 0;
    public static final boolean DEBUG_LOG_ALL_E = 0;
    public static final boolean DEBUG_LOG_ALL_I = 0;
    public static final boolean DEBUG_LOG_WITH_TIME = 0;
    public static final boolean DEBUG_NO_BACK_KEY = 0;
    public static final boolean DEBUG_NO_MENU_KEY = 0;
    public static final boolean DEBUG_NO_SHUTTER_KEY = 0;
    public static final boolean DEBUG_ONE_TOUCH_BURST = 0;
    public static final boolean DEBUG_PLATFORM_FUJI = 0;
    public static final boolean DEBUG_SCENE_EVALUATION_ENABLE = 0;
    public static final boolean DEBUG_STRICT_MODE = 0;
    public static final boolean DEBUG_THUMBNAIL_WITHINFO = 0;
    public static final boolean DEBUG_TOUCH_EDGE = 0;
    public static final boolean DEBUG_TRACE_VIEW = 0;
    ...
    public static final boolean OPT_QUICK_FROM_SHORTCUT = 0;
    public static final boolean OPT_TALLY_ALWAYS_OFF = 1;
    public static final String PACKAGENAME_MMS = "com.sonyericsson.conversations";
    public static final boolean PLAYBACK_VIDEO_IMMIDATELY = 1;
    ...
    static {
        ...
        SHARE_PHOTO_VIDEO_EXCLUDES = Collections.unmodifiableList((List)Collections.emptyList());
        SHARE_MPO_EXCLUDES = Collections.unmodifiableList((List)Arrays.asList((Object[])new String[]{"com.google.android.apps.uploader"}));
    }
