...
public abstract class DependencyApplier {
    ...
    public static DependencyApplier create(Ev ev) {
        switch (.$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$Ev[ev.ordinal()]) {
            default: {
    ...
    public static DependencyApplier create(FaceIdentify faceIdentify) {
        switch (.$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$FaceIdentify[faceIdentify.ordinal()]) {
            default: {
    ...
    public static DependencyApplier create(FocusMode focusMode) {
        switch (.$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$FocusMode[focusMode.ordinal()]) {
            default: {
    ...
    public static DependencyApplier create(Iso iso) {
        switch (.$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$Iso[iso.ordinal()]) {
            default: {
    ...
    public static DependencyApplier create(SmileCapture smileCapture) {
        switch (.$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$SmileCapture[smileCapture.ordinal()]) {
            default: {
    ...
    public static DependencyApplier create(VideoHdr videoHdr) {
        switch (.$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$VideoHdr[videoHdr.ordinal()]) {
            default: {
    ...
    public static DependencyApplier create(VideoSmileCapture videoSmileCapture) {
        switch (.$SwitchMap$com$sonyericsson$android$camera$configuration$parameters$VideoSmileCapture[videoSmileCapture.ordinal()]) {
            default: {
