...
public class SharedPreferencesConstants {
    ...
    public static final String KEY_LAST_PREVIOUS_MANUAL_MODE = "KEY_LAST_PREVIOUS_MANUAL_MODE";
    public static final String KEY_LAST_PREVIOUS_MODE = "KEY_LAST_PREVIOUS_MODE";
