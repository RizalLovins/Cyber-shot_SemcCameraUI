...
extends FocusRectangleWithStateMachine {
    ...
    protected void init(LayoutInflater layoutInflater, View[] arrview) {
        if (this.mRectangle == null) {
            ...
            int n = this.mParentView.getContext().getResources().getDimensionPixelSize(2131296279);
            int n2 = this.mParentView.getContext().getResources().getDimensionPixelSize(2131296278);
